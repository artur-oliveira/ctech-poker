...
var tableCommandSpecs = []commandSpec{
	...
	{Name: "/chat", Desc: "Mostra o histórico do chat desta mesa"},
	{Name: "/react", Args: "<código> [jogador]", Desc: "Envia uma reação (Tab lista códigos e alvos)"},
	{Name: "/player", Args: "<jogador>", Desc: "Mostra perfil, nota e atalhos daquele jogador"},
	{Name: "/note", Args: "<jogador> [tag <cor>|clear|<texto>]", Desc: "Vê/edita sua anotação privada sobre um jogador"},
