...
export function CreateRoomDialog() {
  ...
  return <Dialog open={open} onOpenChange={setOpen}>
    ...
    <DialogContent>
      <DialogHeader><p className="font-mono text-xs tracking-widest text-[#df5a61]">NOVA MESA</p><DialogTitle>Configure sua mesa</DialogTitle><DialogDescription>Escolha como quer jogar. Os valores abaixo são fichas virtuais do sandbox.</DialogDescription></DialogHeader>
