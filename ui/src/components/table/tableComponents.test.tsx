...
describe('table controls', () => {
  ...
  test('renders and dismisses a backend action error', async () => {
    ...
    renderActionBar({error: {code: 'stale_state', message: 'A ação não é mais válida.'}, onDismissErrorAction: onDismiss});
...
describe('hand outcome', () => {
  ...
  test.each([
    [{key: 1, kind: 'win', handCategory: 'pair', winningCards: ['AH', 'AD', 'KC', 'QS', '2D'], stackBefore: 900, stackAfter: 1200}, 'Você venceu!'],
