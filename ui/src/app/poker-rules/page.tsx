    ...
    <main className="app-page">
      ...
      <section className="rules shell">
        ...
        <article id="maos" className="rules-section">
          ...
          <p>Da combinação mais forte à mais fraca. Em caso de empate na mesma categoria, vence quem tem as cartas mais
            altas (kicker) dentro dela.</p>
          <HandRankings/>
        </article>
        ...
        <article id="blinds" className="rules-section">
          ...
          <p>Antes de qualquer carta ser distribuída, os dois jogadores à esquerda do dealer postam uma aposta
            ...
            sempre haja fichas no pote para disputar em cada rodada.</p>
        </article>
        ...
        <article id="acoes" className="rules-section">
          ...
          <ul className="rules-list">
            ...
            <li><span><b>Check</b>: passa a vez sem apostar (somente quando não há aposta pendente na rodada).</span>
            </li>
            <li><span><b>Pagar (Call)</b>: cobre a aposta em aberto para continuar na disputa do pote.</span></li>
            <li><span><b>Aumentar (Raise)</b>: eleva a aposta em aberto, exigindo que os adversários igualem para permanecer na mão.</span>
            </li>
          </ul>
        </article>
        ...
        <article id="fases" className="rules-section">
          ...
          <ol className="rules-steps">
            <li><span><b>Pré-flop</b>: cada jogador recebe duas cartas fechadas. A rodada de apostas inicia no jogador à esquerda do big blind.</span>
            </li>
            ...
            <li><span><b>Showdown</b>: quem permaneceu na mão revela suas cartas. A melhor combinação de 5 cartas (entre as 2 da mão e as 5 da mesa) vence o pote.</span>
            </li>
          </ol>
        </article>
        ...
        <article id="rake" className="rules-section">
          ...
          <div className="rules-fairness-box">
            ...
            <div>
              ...
              <p>Cada baralho é selado com um hash criptográfico antes de a mão começar. Ao final da jogada, a chave
                secreta (server seed) é revelada no histórico para que você possa verificar auditavelmente a ordem exata
                de cada carta.</p>
            </div>
          </div>
        </article>
