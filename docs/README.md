...
| Gamification: leaderboard (public read), achievements, 30-day daily streak trail | **LIVE**        | `leaderboard`, `achievements`, `dailyreward`, `ui/src/app/(app)/{leaderboard,achievements}`, `ui/src/components/store/DailyStreakDialog.tsx` |
| Player tooling: private notes, self-HUD stats, profile showcase + derived milestones | **LIVE**     | `playernotes`, `pokerstats`, `player.Milestones`, `ProfileShowcaseDialog.tsx`, `ProfileMilestones.tsx`, `SelfHudDialog.tsx` |
...
| Local sandbox opponents (issue #395; pilot UX/QA pending)                  | **IN DEVELOPMENT**      | `api/internal/pokerbot`, `api/internal/botfunding`, `api/internal/table/actor_bots.go`, `docs/specs/2026-09-19-local-sandbox-bots.md` |
