...
| Local sandbox opponents (issue #395 foundation; reservation/counter pending) | **IN DEVELOPMENT**   | `api/internal/pokerbot`, `api/internal/table/actor_bots.go`, `docs/specs/2026-09-19-local-sandbox-bots.md` |
