...
func (unacceptedProfiles) SetBetPresetMode(context.Context, string, string) error {
	return nil
}
...
func (unacceptedProfiles) SetReactionWheel(context.Context, string, []string) error {
	return nil
}
