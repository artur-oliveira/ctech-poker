...
func (w *gateWallet) HoldGame(context.Context, string, int64, string, string, string) (string, error) { return "h1", nil }
func (w *gateWallet) ReleaseHold(context.Context, string) error { return nil }
func (w *gateWallet) CashoutGame(context.Context, string, int64, string, []string, string, string) error { return nil }
