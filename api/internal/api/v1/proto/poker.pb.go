...
type ServerMessage struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Type  string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // "connected" | "pong" | "state" | "chat" | "error" | "removed" | "achievement_unlocked" | "room_created" | "room_updated" | "payment_received" | "system_broadcast"
	// payload fields
	...
	PlayerId string         `protobuf:"bytes,4,opt,name=player_id,json=playerId,proto3" json:"player_id,omitempty"` // for chat frame
	...
	Code     string         `protobuf:"bytes,6,opt,name=code,proto3" json:"code,omitempty"`                         // for error frame or removed frame
	...
	Amount          int64    `protobuf:"varint,12,opt,name=amount,proto3" json:"amount,omitempty"`                                          // for payment_received
