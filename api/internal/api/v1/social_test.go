...
func (s *fakeMultiProfileStore) SetEquippedFrame(context.Context, string, string) error { return nil }
func (s *fakeMultiProfileStore) SetEquippedBadges(context.Context, string, []string) error {
	return nil
}
